...
static int singlefilefs_fill_super(struct super_block *sb, void *data,
                                   int silent) {
...
#else
    inode_set_atime_to_ts(root_inode, curr_time);
    inode_set_mtime_to_ts(root_inode, curr_time);
...
static struct dentry *singlefilefs_mount(struct file_system_type *fs_type,
